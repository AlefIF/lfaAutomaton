class AutomatoFD:
    ...
    def minimiza(self):
        ...
        #verificando se o automato eh completo
        if len(self.alfabeto) * len(self.estados) == len(self.transicoes):
            ...
            for i in self.transicoes:
                matrizEstados+=self.transicoes

        else:
            print("O automato nao eh completo, criando novo estado de erro e adicionando transicoes implicitas")
